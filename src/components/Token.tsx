...
export const Token = () => {
    return (
        <div className='xl:h-screen flex justify-center items-center px-4 sm:px-12 md:px-16 py-0 xl:p-16' id='token'>
            <div className='h-full w-full flex flex-col gap-8 lg:gap-4'>
                ...
                <div className='grow flex flex-col lg:flex-row gap-8 lg:gap-16 xl:gap-12'>
                    ...
                    <div className='grow flex flex-row lg:flex-col gap-4 xl:gap-8 pr-2'>
