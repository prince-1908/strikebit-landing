...
export const Roadmap = () => {
    return (
        <div className='xl:h-screen flex justify-center items-center my-24 xl:my-0 px-4 py-16 sm:p-16 xl:px-24  xl:py-48' id='roadmap'>
            <div className='w-full h-full flex flex-col gap-16'>
                <h1 className='text-5xl xl:text-7xl font-semibold'>Roadmap</h1>

                <div className='grow overflow-x-auto'>
                    <div className='w-[82rem] grid grid-cols-5'>
                        <div className="bg-gray p-7 flex flex-col justify-between gap-8 xl:gap-0">
                            <h3 className='gradient-text-1 font-semibold text-2xl'>Q1 2021</h3>
                            <div className='grid gap-4 lg:gap-0 xl:gap-4'>
